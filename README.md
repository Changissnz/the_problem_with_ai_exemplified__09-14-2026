...
extravagant, the state-sponsored aspect is quite justifiable. 
...
and load it up with birdshot. That's mainly useful for birds and drones." With Bernie, the moralism is "restraint and equal distribution." With AOC and the newcomers 
to the Democratic Party, there are calls for more cultural intersection. **There are only so many hours in the day.** Industry concerns around A.I., in some demographics, 
revolve around control. 
